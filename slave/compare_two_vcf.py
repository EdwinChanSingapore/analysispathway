...
def execute_main(paths):
    ...
    generated_truth_dictionary = create_truth_dictionary(truth)
    print "length of truth dictionary", len(generated_truth_dictionary)
    sample_dictionary = create_sample_dictionary(sample)
    print "length of sample dictionary", len(sample_dictionary)
    actual_predictions, final_array_of_samples, final_truth_list = match_created_with_truth(generated_truth_dictionary,
                                                                                            sample_dictionary)
